...
//|    Cria ordens no sentido oposto a cada deal.                    |______________________________________
//|                                                                                                         |
//|    - Tecla       F: coloca o EA modo fechar-todas-as-posicoes, embora feche apenas a posicao do ativo 1.|
//|    - Tecla SHIFT+F: coloca novamente o EA no modo de aceitar novas ordens.                              |
//|                                                                                                         |
//| Versao p7-004-003-01                                                                                    |
//|    - Corrigido BUG:                                                                                     |
//|      - Operar o segundo ativo ainda que nao haja posicao no primeiro.                                   |
...
//|                                                                  |
//| Versao p8-000-000-00                                             |
//|    - Pretende:                                                   |
//|                                                                  |_________________________________________________
//|      1. Usar uma classe para executar as tarefas do EA. Toda a inteligencia de negocio serah colocada nesta classe |
//|         e o EA comandarah os metodos da classe.                                                                    |
//|                                                                                                                    |
//|      2. Tirar as estrategias de floresta aleatoria e rede neural. Seriam implementadas em versoes posteriores.     |
//|                                                                                                                    |
//|      3. Decidir por uma estrategia simples de negociacao pra testar a classe do EA. Possibilidade de usar a        |
//|         estrategia descrita no item abaixo.                                                                        |
//|                                                                                                                    |
//|      4. Usar estrategia baseada no volume profile para decidir pontos de entrada e saida. Inicialmente conforme    |
//|         abaixo:                                                                                                    |
//|                                                                                                                    |
//+--------------------------------------------------------------------------------------------------------------------+
...
MqlDateTime                m_date;
string                     m_name = "OSE-P7-000-000-00"; // operacao manual assistida por robo
osc_db                     m_db                      ;
