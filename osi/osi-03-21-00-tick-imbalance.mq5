//+------------------------------------------------------------------+
//|                                  osi-03-21-00-tick-imbalance.mq5 |
...
#define OSI_FEIRA_SHORT_NAME "osi-03-21-tib"
#define DEBUG_TICK     false

#property description "Calcula barras de desequilibrio de ticks (tib)."
#property description "Inspirada na definição de Marcos Lopez de Prado (2018)."
#property description "Esta versão não implementa o tamanho dinâmico esperado da quantidade de ticks T"
